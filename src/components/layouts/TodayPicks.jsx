...
const TodayPicks = props => {
    ...
    return (
        <Fragment>
            <section className="tf-section today-pick live-auctions">
    ...
    >
        {
            data.slice(0, 8).map((item, index) => (
                <SwiperSlide key={index}>
                    <div className="swiper-container show-shadow carousel live-auctions">
                                ...
                                <div className="slider-item">
                                    <div className="sc-card-product">
                                        ...
                                        <div className="card-bottom">
                                            <Link to={`${config.baseUrl}nft-details/` + item.id}>
                                                <button className="sc-button style bag fl-button pri-3 no-bg"><span>Buy</span></button></Link>
